...
const pricing = [
  {
    ...
    features: [
      ...
      "$8(4%) per (DH) booking; $10(4.2%) per (AH) fee",
      "Call transcripts & summaries",
      "Email support",
      "Overage: $0.49/min (DH) • $0.59/min (AH)",
    ],
  },
  {
    name: "Plus",
    ...
    features: [
      ...
      "$6(3%) per (DH) booking; $8(3.5%) per (AH) fee",
      "Priority email support",
      "Minute rollover (1 month)",
      "Overage: $0.39/min (DH) • $0.49/min (AH)",
  ...
  },
  {
    ...
    features: [
      ...
      "$4.99(2%) per (DH) booking; $6.99(2.5%) per (AH) fee",
      "Priority onboarding (72h)",
      "Dedicated success check-ins",
      "Overage: $0.29/min (DH) • $0.39/min (AH)",
