...
const pricing = [
  {
    ...
    features: [
      ...
      "Live booking + confirmations (Google Calendar)",
      "Spam & robocall filtering",
      "Call transcripts & summaries",
      "Email support",
      "Per-booking fees: $6 (business hrs) / $9 (after-hrs)",
      "Overage: $0.39/min (BH) • $0.49/min (AH)",
      "Minute packs: 250/$109 • 1,000/$359",
      "Billed for AI talk time only (ringing/hold excluded)",
      "Custom Voice add-on: $50/mo + $2/booking (optional)",
    ],
  },
  {
    name: "Plus",
  ...
  },
  {
    ...
    features: [
      ...
      "Minute packs: 250/$109 • 1,000/$359",
      "Billed for AI talk time only (ringing/hold excluded)",
      "Custom Voice INCLUDED (owner/brand voice, no add-on fee)",
    ],
  },
];
